package com.example.dm2.ejerciciomultimediaconiconos;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.john_guidetti_song);
        finalTime=mediaPlayer.getDuration();//antes no poniamos nada
        seekBar = (SeekBar) findViewById(R.id.seekBar);
        String cancion= getResources().getResourceEntryName(R.raw.john_guidetti_song);
    ...
    public void forward(View view) {
        if ((timeStart + forwardTime) <= finalTime) {
            timeStart = timeStart + backwardTime;//antes menos
